...
namespace Sunbox.Avatars {
    ...
    public class AvatarCustomization : MonoBehaviour {
        ...
        [AvatarFloatFieldAttribute("Ã¼Áö¹æ", "bodyFat", -100, 100, Section = SECTION_BODY_PARAMETERS)]
        public float BodyFat = 0f;

        [AvatarFloatFieldAttribute("±ÙÀ°", "bodyMuscle", 0, 100, Section = SECTION_BODY_PARAMETERS)] 
        public float BodyMuscle = 0f;

        [AvatarFloatFieldAttribute("Å° (m)", "bodyHeightMetres", 1.5f, 2.1f, 1.5f, 2.1f, IgnoreInPlayMode = true)] 
        public float BodyHeight = 1.8f;
        
        [AvatarFloatFieldAttribute("°¡½¿ Å©±â (¿©¼º Àü¿ë)", "breastSize", -100, 100, Section = SECTION_BODY_PARAMETERS)]
        public float BreastSize = 0f;
        
        [AvatarFloatFieldAttribute("ÄÚ ±æÀÌ", "noseLength", -100, 100, Section = SECTION_FACE_PARAMETERS)]
        public float NoseLength = 0f;

        [AvatarFloatFieldAttribute("ÀÔ ³Êºñ", "lipsWidth", -100, 100, Section = SECTION_FACE_PARAMETERS)]
        public float LipsWidth = 0f;

        [AvatarFloatFieldAttribute("ÅÎ ³Êºñ", "jawWidth", -100, 100, Section = SECTION_FACE_PARAMETERS)]
        public float JawWidth = 0f;

        [AvatarFloatFieldAttribute("´«½ç ³Êºñ", "browWidth", -100, 100, Section = SECTION_FACE_PARAMETERS)]
        public float BrowWidth = 0f;

        [AvatarFloatFieldAttribute("´«½ç ³ôÀÌ", "browHeight", -100, 100, Section = SECTION_FACE_PARAMETERS)]
        public float BrowHeight = 0f;

        [AvatarFloatFieldAttribute("´« Å©±â", "eyesSize", -100, 100, Section = SECTION_FACE_PARAMETERS)]
        public float EyesSize = 0f;
        
        [AvatarFloatFieldAttribute("´« °¨Àº Á¤µµ", "eyesClosedDefault", 0, 100, Section = SECTION_FACE_PARAMETERS)]
        public float EyesClosedDefault = 0f;

        [AvatarIntegerField("ÇÇºÎ ÀçÁú", "skinMaterialIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "MaleSkinMaterials")]
        public int SkinMaterialIndex = 0;

        [AvatarIntegerField("¸Ó¸®½ºÅ¸ÀÏ", "hairStyleIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "HairItems")]
        public int HairStyleIndex = 0;

        [AvatarIntegerField("¸Ó¸® ÀçÁú", "hairMaterialIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "HairItems", IsVariationField = true)]
        public int HairMaterialIndex = 0;

        [AvatarIntegerField("ÇÇºÎÅÐ ½ºÅ¸ÀÏ", "facialHairStyleIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "FacialHairItems")]
        public int FacialHairStyleIndex = 0;

        [AvatarIntegerField("ÇÇºÎÅÐ ÀçÁú", "facialHairMaterialIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "FacialHairItems", IsVariationField = true)]
        public int FacialHairMaterialIndex = 0;

        [AvatarIntegerField("´« ÀçÁú", "eyeMaterialIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "EyeMaterials")]
        public int EyeMaterialIndex = 0;

        [AvatarIntegerField("¼Ó´«½ç ÀçÁú", "lashesMaterialIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "LashesMaterials")]
        public int LashesMaterialIndex = 0;

        [AvatarIntegerField("´«½ç ÀçÁú", "browMaterialIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "BrowMaterials")]
        public int BrowMaterialIndex = 0;

        [AvatarIntegerField("¼ÕÅé ÀçÁú", "nailsMaterialIndex", Section = SECTION_FEATURE_STYLES, ArrayDependancyField = "NailMaterials")]
